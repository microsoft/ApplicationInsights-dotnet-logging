...
..\packages\OpenCover.4.6.519\tools\OpenCover.Console.exe -register:user "-target:C:\Program Files (x86)\Microsoft Visual Studio 14.0\Common7\IDE\CommonExtensions\Microsoft\TestWindow\vstest.console.exe" "-targetargs:$binRoot\$configuration\test\Log4NetAppender.Net40.Tests\Microsoft.ApplicationInsights.Log4NetAppender.Net40.Tests.dll $binRoot\$configuration\test\Log4NetAppender.Net45.Tests\Microsoft.ApplicationInsights.Log4NetAppender.Net45.Tests.dll $binRoot\$configuration\test\NLogTarget.Net40.Tests\Microsoft.ApplicationInsights.NLogTarget.Net40.Tests.dll $binRoot\$configuration\test\NLogTarget.Net45.Tests\Microsoft.ApplicationInsights.NLogTarget.Net45.Tests.dll $binRoot\$configuration\test\TraceListener.Net40.Tests\Microsoft.ApplicationInsights.TraceListener.Net40.Tests.dll $binRoot\$configuration\test\TraceListener.Net45.Tests\Microsoft.ApplicationInsights.TraceListener.Net45.Tests.dll $binRoot\$configuration\src\NuGet.Tests\Xdt.Tests\Xdt.Tests.dll /logger:trx" "-filter:+[Microsoft.ApplicationInsights*]* -[*Tests]*" -hideskipped:All -output:.\coverage.xml
